...
namespace ImageService.Controller.Handlers
{
    public class DirectoyHandler : IDirectoryHandler
    {
        ...
        public DirectoyHandler(IModalParameters modalParameters, ILoggingService service)
        {
            IsActive = true;
            _logger = service;
            _controller = new ImageController(modalParameters, service);
        ...
        {
            bool commandExecutionResult, responseBack;
            string message = _controller.ExecuteCommand(e.CommandId, e.Args, out commandExecutionResult, out responseBack);
