...
namespace ImageService
{
    ...
    public partial class ImageService : ServiceBase
    {
        ...
        private void InitializeServiceObjects()
        {
            ...
            _eventLog.WriteEntry("Creating tcp socket");
            TcpServerAdapter adapter = new TcpServerAdapter(8000, _logger, _configuration, _server);
            _server.NotifyClientsHandlerRemoved += adapter.NotifySubscribedClientsUpdateRecieved;
            _logger.NotifyClientsNewLog += adapter.NotifySubscribedClientsUpdateRecieved;
            adapter.Start();
        }
