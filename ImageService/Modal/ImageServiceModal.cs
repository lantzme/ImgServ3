...
namespace ImageService.Modal
{
    ...
    {
        #region Members
        private string _outputFolder;                   // The Output Folder
        private int _thumbnailSize;                      // The Size Of The Thumbnail Size
        ...
        /// </summary>
        /// <param name="outputFolder">The modal's output folder</param>
        /// <param name="thumbnailSize">The required thumbnail size for images</param>
        ...
        public string AddFile(string path, out bool result)
        {
            ...
            DirectoryInfo di = Directory.CreateDirectory(_outputFolder);
            ...
            try
            {
                if (File.Exists(path))
                {
                    ...
                    string thumbFolderPath = _outputFolder + "\\Thumbnails\\" + y + "\\" + m;
                    string actualImgFolderPath = _outputFolder + "\\" + y + "\\" + m;
        ...
        public void HandleThumbnail(string path, string thumbFolderPath)
        {
            ...
            Image thumb = img.GetThumbnailImage(_thumbnailSize, _thumbnailSize, myCallback, IntPtr.Zero);
